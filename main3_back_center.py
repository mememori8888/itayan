...
# )
for c in range(2,50,5):
    driver.get(url)
    time.sleep(2)
    #北海道を指定
    area_select = driver.find_element(By.XPATH,'//*[@id="id_state"]/option[13]')
    area_select.click()
...
#要素数をカウント
    ...
    for i in range(1,count,1):
        ...
        try:
            ...
            close.click()
            # center_btn = driver.find_element(By.XPATH,'/html/body/div/div/div[2]/div[2]/div/div/div[1]/div[1]/form/div[2]/div[2]/div/div[2]')
            # center_btn.click()
